...
```groovy
implementation "com.github.tommyettinger:jdkgdxds_interop:2.1.3.1"
```
...
This library currently depends on libGDX 1.14.1, and uses its `Json` class heavily. Newer versions should be checked for
...
```groovy
implementation "com.badlogicgames.gdx:gdx:1.14.1:sources"
...
implementation "com.github.tommyettinger:jdkgdxds_interop:2.1.3.1:sources"
```
